...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=210&section=header&text=🍣%20Sakura%20Asian%20Kitchen&fontSize=46&fontColor=ffffff&animation=fadeIn&desc=Restaurant%20AI%20Agent&descSize=22&descAlignY=78" width="100%" alt="header"/>

<!-- Animated typing tagline -->
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&duration=3000&pause=800&color=F97316&center=true&vCenter=true&width=650&lines=🤖+AI-Powered+Restaurant+Assistant;🍜+Menu+Q%26A+·+📅+Reservations+·+❌+Cancellations;🧠+LangChain+%2B+OpenAI+%2B+SQLite+%2B+n8n;📧+Automated+Email+Confirmations" alt="typing animation"/>
